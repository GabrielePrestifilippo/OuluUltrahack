...
var enableInlineVideo = function () {
    ...
    var m, y = "object" == typeof document && "object-fit" in document.head.style && !matchMedia("(-webkit-video-playable-inline)").matches, h = "bfred-it:iphone-inline-video", b = "bfred-it:iphone-inline-video:event", g = "bfred-it:iphone-inline-video:nativeplay", E = "bfred-it:iphone-inline-video:nativepause", w = [], T = 0;
    return f
}();
;/**
...
THREE.BendModifier.prototype = {
    ...
    modify: function (geometry) {
        ...
        var thirdAxis = new THREE.Vector3();
        ...
        for (var i = 0; i < geometry.vertices.length; i++) {
            ...
            oldVertices[i] = new THREE.Vector3();
        ...
        if (this.offset < tiles.length - 1 && tiles[this.offset + 1].material.visible) {
            ...
            for (var i = tiles.length - 1; i >= 0; i--) {
                ...
                new TWEEN.Tween(tiles[i].position)
                    .to({
                        y: ( i - offset ) * -this.v_gap,
                        z: Math.abs(i - offset) * -this.d_gap
                    }, duration)
                    .easing(this.animationEasing)
                    .start();
